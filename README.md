...
- Visible hardware hero artwork with Pi Zero-style boards, Orange/RK-style alternatives, and a laptop running Linux-style Walker OS software
- Start-page AI runtime section covering API-key primary models such as OpenAI or Gemini, plus Ollama local fallback
- Walker voice preview audio sample in `dist/assets/walker-preview-voice-clean.mp3`
